    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildFAQItem(
            "How do I log my blood glucose?",
            "To log your blood glucose, open the 'Glucose' menu and tap the '+' button at the bottom right. Enter your measurement data.",
          ),
          _buildFAQItem(
            "How to set medication reminders?",
            "Open the 'Medication' menu, select '+ Add Reminder', and set the time and dosage as needed.",
          ),
          _buildFAQItem(
            "How do I export my data?",
            "Open the 'Settings' menu, select 'Export Data', choose the time range and desired file format.",
          ),
          _buildFAQItem(
            "How to change glucose measurement units?",
            "Open the 'Settings' menu, select 'Glucose Unit', and choose the desired unit (mg/dL or mmol/L).",
          ),
        ],
      ),
    );
